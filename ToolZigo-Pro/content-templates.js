...
function templateLicenseGate(minimized) {
  return '<div id="ql-header">' +
    ...
    '<div class="ql-header-right">' +
       '<span class="ql-badge">GS v9.6.9</span>' +
...
function templateMainUI(greeting, statusBadge, minimized) {
  ...
  '</div>' +
   '<div id="ql-body">' +
    ...
    '<div id="ql-reseller-btn" style="display:none;margin-bottom:14px">' +
      '<a href="https://wa.me/8801860036852" target="_blank" style="display:flex;align-items:center;gap:8px;padding:10px 14px;border-radius:10px;border:1px solid rgba(168,85,247,0.3);background:rgba(168,85,247,0.06);color:var(--ql-accent,#A855F7);text-decoration:none;font-size:12px;font-weight:700;transition:all 0.2s">' +
  ...
  '<div id="ql-footer" class="ql-footer">' +
    '<div class="ql-footer-row">' +
      '<a href="https://wa.me/8801860036852" target="_blank" class="ql-support-link">' + SVG_ICONS.headphones + ' Support</a>' +
       '<span class="ql-footer-version">GS v9.6.9</span>' +
    '</div>' +
...
var BRL_TO_MZN = 12.6;
var QL_CONTACT_URL = "https://wa.me/8801860036852";
