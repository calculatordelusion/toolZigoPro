...
(function(){
  const SUPABASE_URL = "https://tvttbagljqbkcobruwnl.supabase.co";
    ...
    loadChatHistory(function() {
      body.innerHTML = '<div id="sp-update-banner" style="display:none"></div>' +
        ...
        '<div id="sp-reseller-btn" style="display:none;margin-bottom:14px">' +
          '<a href="https://wa.me/8801860036852" target="_blank" style="display:flex;align-items:center;gap:8px;padding:10px 14px;border-radius:10px;border:1px solid rgba(168,85,247,0.3);background:rgba(168,85,247,0.06);color:var(--ql-accent);text-decoration:none;font-size:12px;font-weight:700;transition:all 0.2s">' +
  ...
  var REMOVE_WATERMARK_URL = "https://tvttbagljqbkcobruwnl.supabase.co/functions/v1/remove-watermark";
  var PUBLISH_PROJECT_URL = "https://tvttbagljqbkcobruwnl.supabase.co/functions/v1/publish-project";
  var ENABLE_CLOUD_URL = "https://tvttbagljqbkcobruwnl.supabase.co/functions/v1/enable-cloud";
