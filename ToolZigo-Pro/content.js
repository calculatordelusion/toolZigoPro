...
const VALIDATE_URL = "https://tvttbagljqbkcobruwnl.supabase.co/functions/v1/validate-license";
const OPTIMIZE_URL = "https://tvttbagljqbkcobruwnl.supabase.co/functions/v1/optimize-prompt";
const NOTIFICATIONS_URL = "https://tvttbagljqbkcobruwnl.supabase.co/rest/v1/notifications?select=*&order=created_at.desc&limit=20";
const PACKAGES_URL = "https://tvttbagljqbkcobruwnl.supabase.co/rest/v1/packages?select=*&is_active=eq.true&order=sort_order.asc";
const EXT_PAYMENT_URL = "https://tvttbagljqbkcobruwnl.supabase.co/functions/v1/process-extension-payment";
const PROXY_COMMAND_URL = "https://tvttbagljqbkcobruwnl.supabase.co/functions/v1/proxy-command";
const REMOVE_WATERMARK_URL = "https://tvttbagljqbkcobruwnl.supabase.co/functions/v1/remove-watermark";
const PUBLISH_PROJECT_URL = "https://tvttbagljqbkcobruwnl.supabase.co/functions/v1/publish-project";
const ENABLE_CLOUD_URL = "https://tvttbagljqbkcobruwnl.supabase.co/functions/v1/enable-cloud";
const SUPABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InR2dHRiYWdsanFia2NvYnJ1d25sIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODA2ODM1OTksImV4cCI6MjA5NjI1OTU5OX0.7NgHbsoI3cAQ0fLo5gz4V4sm8iKK-MIitrbEWzmfO2s";
...
async function showPaymentUI(box, preselectedPkg){
  ...
  document.querySelectorAll(".ql-brl-buy").forEach(function(btn){
    btn.addEventListener("click", function(){
      ...
      var url = "https://wa.me/8801860036852";
...
function setupFileAttachment() {
  return; // file attach system disabled in VibeX Max v9.6.9
...
var VERSIONS_URL_POPUP = "https://tvttbagljqbkcobruwnl.supabase.co/rest/v1/extension_versions?select=version,changelog,file_path,is_alert_active&order=created_at.desc&limit=1&is_alert_active=eq.true";
var USER_ROLES_URL_POPUP = "https://tvttbagljqbkcobruwnl.supabase.co/rest/v1/user_roles?select=role";
...
function setupDownloadProject() {
  ...
  btn.addEventListener('click', async function() {
    ...
    try {
      // ---- Feature flag gate ----
      try {
        var flagUrl = "https://tvttbagljqbkcobruwnl.supabase.co/rest/v1/feature_flags?select=enabled&flag_key=eq.download_files";
...
async function checkForUpdatePopup() {
  try {
    ...
    if (latest.version !== CURRENT_EXT_VERSION_POPUP && latest.is_alert_active) {
      ...
      if (banner) {
        var dlUrl = latest.file_path ? "https://tvttbagljqbkcobruwnl.supabase.co/storage/v1/object/public/extension-releases/" + latest.file_path : null;
...
async function checkResellerRolePopup() {
  try {
    ...
    var licData = await bgFetch("https://tvttbagljqbkcobruwnl.supabase.co/rest/v1/licenses?select=user_id&license_key=eq." + encodeURIComponent(storageData.ql_license_key) + "&limit=1", { method: "GET", headers: { apikey: SUPABASE_ANON_KEY } });
